...
{
    /// <summary>
    /// Grammar of the Dazzle Query Language.
    /// </summary>
    [Language("DQL", "v1", "DQL v1 grammar")]
    public class DqlGrammar : Grammar
    {
        public DqlGrammar() : base(false)
        {
            //LQL is case insensitive
            ...
            //Non-terminals
            var Id = new NonTerminal("Id", typeof(MemberAccessNode));
            ...
            typeName.Rule = ToTerm("BIT") | "DATE" | "TIME" | "TIMESTAMP" | "DECIMAL" | "REAL" | "FLOAT" | "SMALLINT" |
                            "INTEGER"
                            | "INTERVAL" | "CHARACTER"
                            // MS SQL types:  
